    ...
    var body: some Scene {
        WindowGroup {
            ContentView()
                ...
                .environment(installationManager)
                .frame(
                ...
                .onAppear {
                    ...
                    BackupService.shared.configure(appState: appState)
                    CollectorScheduler.shared.configure(appState: appState)
                    KnowledgeService.shared.configure(appState: appState)
        ...
        DispatchQueue.global(qos: .utility).async {
            ...
            if !hasWorkspace {
                ...
                do {
                    ...
                    StorageService.shared.writeLog("Failed to seed MCP servers: \(error)", to: "errors")
                }
            } else {
                ...
                do {
                    ...
                    StorageService.shared.writeLog("Failed to update MCP server flags: \(error)", to: "errors")
                }
            }
        }
    }
